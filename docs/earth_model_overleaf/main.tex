...
\begin{figure}[p]
  ...
  \caption{The same three-day simulation expressed as colour indices, using astronomical notation \(m_R - m_G\), \(m_R - m_B\), and \(m_G - m_B\). This form emphasises chromatic evolution in a representation familiar to astronomers while remaining directly tied to the radiance ratios. Caption text to be refined after Overleaf upload.}
